...
internal data class medicine(
    val name: String?,
    val highmodifier: Double?,
    val highrange: Boolean?,
    val instructions: String?,
    val messageMgs: String?,
    val messageMls: String?,
    val mgsmax: Int?,
    val mlsvar: Double?,
    val mgsmaxhigh: Int?,
    val mgsvar: Double?,
    val mgsvarstrephigh: Int?,
    val numberOfTimesADay: String?,
    val nzflink: String?,
    val strepdrug: Boolean?,
    val strepfrequency: String?,
    val tabletOnly: Boolean?,
    val tabletSize: String?,
    val mlsvarstreplow: Int?,
    val mlsvarstrep: Double?,
    val mgsvarstrep: Double?,
    val mlsstrepmax: Double?,
    val mgsstrepmax: Int?,
    val mlsvarstrephigh: Int?,
    val mgsvarstreplow: Int?,
    val mlsmax: Int?,
    val strepweightcutoff: Boolean?,
    val mlsmaxhigh: Int?,
    val mlsvaralt: Double?,
    val mgsvaralt: Int?,
    val numberOfTimesADayAlt: String?,
    val mlsmaxalt: Int?,
    val mgsmaxalt: Int?,
    val messageshow: Boolean?,
    val weightrange: Boolean?,
    val rangeWeightCutOff: Int?,
    val rangeWeightCutOff2: Int?,
    val range1doseMls: Int?,
    val range1doseMgs: Int?,
    val range2doseMls: Int?,
    val range2doseMgs: Int?,
    val sachetsmax: Int?,
    val loadingdose: Boolean?,
    val mlsvarloading: Double?,
    val mgsvarloading: Int?,
    val mlsmaxloading: Double?,
    val mgsmaxloading: Int?,
)


/*
        var drugOptions = listOf(
            medicine(
                name = "Paracetamol120",
                tabletOnly = false,
                mlsvar = 0.625,
                ...
                mlsstrepmax = 0.0,
                mgsstrepmax = null,
                mlsvarstrephigh = null,
                mgsvarstreplow = null,
                strepweightcutoff = null,
                mlsmaxhigh = null,
                mlsvaralt = null,
                mgsvaralt = null,
                numberOfTimesADayAlt = null,
                mlsmaxalt = null,
                mgsmaxalt = null,
                messageshow = null,
                weightrange = null,
                rangeWeightCutOff = null,
                rangeWeightCutOff2 = null,
                range1doseMls = null,
                range1doseMgs = null,
                range2doseMls = null,
                range2doseMgs = null,
            ...
            medicine(
                ...
                mlsmaxloading = 62.5,
                mgsmaxloading = 1500,
                instructions = "<div class='message__section-dosing-item message__section-dosing-label'><strong>General Dosing=</strong> <br> <div class='message__section-dosing-instructions'><span class='age-group'>1 month - 18 years</span> 15 mg/kg per dose (maximum 1 g) every four hours as needed for pain or fever. Do not take more than 4 doses in 24 hours AND 4 grams in 24 hours.</div></div>",
                nzflink = "https=//nzfchildren.org.nz/nzf_2439",
                highmodifier = null,
                highrange = null,
                messageMgs = null,
            ...
            medicine(
                ...
                mlsmax = 20,
                mgsmax = 500,
                instructions = "<div class='message__section-dosing-item message__section-dosing-label'><strong>General Dosing=</strong> <br><div class='message__section-dosing-instructions'><span class='age-group'>1 month - 18 years</span> 10 mg/kg (maximum 500 mg) three times daily </div></div>",
            ...
            medicine(
                name = "Coamoxiclav125-31.25nostrepinfo",
            ...
            medicine(
                name = "Coamoxiclav250-62.5nostrepinfo",
            ...
            medicine(
                ...
                mlsmax = 20,
                mgsmax = 960,
                instructions = "<div class='message__section-dosing-item message__section-dosing-label'><strong>General Dosing=</strong> <br> <div class='message__section-dosing-instructions'><span class='age-group'>6 weeks - 18 years</span> 24 mg/kg (maximum 960 mg) twice daily </div></div>",
