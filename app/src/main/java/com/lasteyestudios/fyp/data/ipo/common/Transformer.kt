package com.lasteyestudios.fyp.data.ipo.common
...
import com.lasteyestudios.fyp.data.models.ipodetailsmodel.*
...
import com.lasteyestudios.fyp.utils.LAST_TO_LAST_TO_LAST_YEAR
import com.lasteyestudios.fyp.utils.LAST_TO_LAST_YEAR
import com.lasteyestudios.fyp.utils.LAST_YEAR
    ...
    * */
    ...
    fun growIPOListingToData(res: JsonObject?): IPOListingModel? {
        try {
            ...
            val diseases = res?.get("diseases")?.asJsonArray
            Log.d(IPO_LOG_TAG, "diseases $diseases")

            return IPOListingModel(listOf(), listOf(), listOf(), listOf())
        } catch (e: Exception) {
            Log.d(
                IPO_LOG_TAG,
